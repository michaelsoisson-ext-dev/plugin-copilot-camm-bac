---
name: tdd-green
description: TDD Green phase for writing MINIMAL implementation to pass tests. Implement minimal code to satisfy Gitlab issue requirements and make failing tests pass without over-engineering.'
